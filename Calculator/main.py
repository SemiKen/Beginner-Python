...
class Calculator:
    ...
    def __init__(self,master):
        ...
        Button(width=11,height=2,text='Del',relief='flat',bg='white',command=self.delete).place(x=270, y=0.5)
    ...
    def show(self, value):
        ...
        if self.currentindex >= 1 and checksymbol() and self.entry_value[self.currentindex-1] == '0':
